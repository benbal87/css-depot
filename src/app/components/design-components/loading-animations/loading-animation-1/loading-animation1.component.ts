...
@Component({
  selector: 'app-loading-animation-1',
  standalone: true,
  imports: [],
  templateUrl: './loading-animation1.component.html',
  styleUrl: './loading-animation1.component.scss'
})
export class LoadingAnimation1Component implements GeneralDesignComponent {
          ...
          svg.loading {
            ...
            & > g > path {
              ...
              @for $index from 1 through 7 {
                &:nth-child(#{$index}) {
                  @include get-animation(($index - 1) / 10);
                }
              }
            }
          }
